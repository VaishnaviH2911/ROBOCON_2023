...
void loop() {
  ...
  bool mrs = digitalRead(2);
  bool ms = digitalRead(11);
  bool mls = digitalRead(10);
  bool ls=digitalRead(8);

  if(ls==0 && mls==0 && ms==1 && mrs==0 && rs==0)
  {
    forward();
